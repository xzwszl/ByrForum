...
public class  ByrBase {
	...
	public static final String CAMERA_DIR = "/XinYou/pic/camera/";
	
	public static final int ATTACHMENT_COUNT  = 20;
	
	public static int ATTACHMENT_SIZE = 5*1024*1024;
	
	public static int mail_count = 20;
}
